    ...
    <div id="home-view">
        <header v-if="!isMobile" id="head-1">
            <div class="h-head">
                ...
                <div class="vl"></div>
                <svg @click="handleMenu" class="icon" id="menu-icon" width="16" height="16" viewBox="0 0 16 16"
            ...
            <div class="h-head">
                <svg class="icon" id="bell-icon" width="17" height="18" viewBox="0 0 17 18" fill="none"
                ...
                <div class="vl"></div>
                <svg class="icon" xmlns="http://www.w3.org/2000/svg" height="22px" viewBox="0 -960 960 960" width="22px"
                    fill="#F7F7F7">
                    <path class="contorn-1"
                ...
                <div class="vl"></div>
                <svg class="icon" id="user-icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
        ...
        <header v-if="isMobile" id="head-2">
            <img src="../assets/head/logo.png" alt="" height="24px">
            <div class="h-head">
                <svg class="icon" id="menu-icon" width="16" height="16" viewBox="0 0 16 16" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_42_434)">
                        <path class="contorn-1"
                            d="M3 0H1C0.447715 0 0 0.447715 0 1V3C0 3.55228 0.447715 4 1 4H3C3.55228 4 4 3.55228 4 3V1C4 0.447715 3.55228 0 3 0Z"
...
header {
    ...
    border-top: 1px 0px 1px 0px solid #424650;
    z-index: 99;
}
...
@media screen and (min-width: 769px) {
    ...
    .v-leave-to {
        ...
        /* se desliza hacia arriba al entrar */
    }
    .v-enter-to,
    .v-leave-from {
        opacity: 1;
