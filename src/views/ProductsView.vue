<template>
    <div ref="containerRef" class="products-view">
        <div class="top" :style="{ height: topHeight + 'px' }">
            <div class="head-top">
                <h3>Productos <span>(100)</span></h3>
                <div class="buttons">
                    <svg class="btn" width="34" height="35" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class="btn btn-2">Crear nuevo</button>
                </div>
            </div>
            <div class="body-top">
                <div class="labels">
